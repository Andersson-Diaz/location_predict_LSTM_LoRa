...
def ejecutar_entrenamiento(r,t,data):
    ...
    #print(modelo.summary())
    modelo.save('model_LSTM_tarjeta5.h5')
    import joblib
    joblib.dump(scaler, 'scaler_tarjeta5.save')                
    ...
    #Guardamos el modelo
    model_time.save('tiempo_entrenado_tarjeta5.h5')
    import joblib
    #guardamos el normalizador
    joblib.dump(sc, 'scaler_tiempo_tarjeta5.save')   
    fin = time.time()
