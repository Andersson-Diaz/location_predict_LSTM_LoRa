...
def funcion1(dataset):
    ...
    #ir guarda el valor de donde empiezan los valores válidos, diferentes de cero.
    ...
    try: 
        ...
        while(dataset.iloc[ir,[4]].values!=0 and dataset.iloc[ir,[4]].values!= ''):
                ir=ir+1
                count2=count2+1
                print('valor de ir: ', ir)
                print('longitud dataset',len(dataset))
                ire = iron.iloc[0,1]
                if count2==len_training and ir==ire+len_training:
                    print('count2', count2)
                    count2 = 0
                    print('count2 = ', count2)
                    print('ir : ',ir)
                    iront = pd.read_csv('valor_final_inicio_entrenamiento.csv')
